...
class RodReader():
    ...
    def get_cif_value_from_key(self, value_key: str, is_cif_loop_value=False) -> Union[str,list,np.array]:
        """
    ...
    def extract_keys_and_values_from_cif(self):
        ...
        cif_key_dict_with_loop_boolean = self.get_keys_and_loop_boolean(key_pos_non_loop, key_pos_in_loops)
        ...
        for key in cif_key_dict_with_loop_boolean:
            ...
            cif_dict_key_value_pair_dict[key] = self.get_cif_value_from_key(key, is_cif_loop_value=bool_loop_value)
