...
#
"""
Data model for data from Witec instruments.
"""

from dataclasses import dataclass, field
import numpy as np

from pynxtools_raman.reader_utils import RamanDataclass


@dataclass
class WitecHeader(RamanDataclass):
    no_of_regions: int = 0
    software_version: str = ""


@dataclass
class WitecRegion(RamanDataclass):
    region_id: int = 0
    region_name: str = ""
    energy_size: int = 0
    energy_scale: str = ""
